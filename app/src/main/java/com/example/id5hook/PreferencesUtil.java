    ...
    public synchronized void saveParam(String key, Object object) {
        ...
        if ("String".equals(type)) {
            ...
            try {
                ...
                Log.d(this.getClass().getSimpleName(), "benija;save object success");
            } catch (IOException e) {
                e.printStackTrace();
                Log.e(this.getClass().getSimpleName(), "benija;save object error");
            }
        }
        Log.d("benija", "saveParam:" + key + "----" + object.toString());
        editor.commit();
    }
